Change the hostname of one of a cluster node:
=============================================
...
Verify the hostname change occur a status change on the bootstrap:
.. code-block:: shell
        $ kubectl get nodes
...
Delete the hold node (here node2.novalocal):
.. code-block:: shell
